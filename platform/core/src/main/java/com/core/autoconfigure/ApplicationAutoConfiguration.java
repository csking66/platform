...
import com.core.config.RabbitConfig;
import com.core.config.RedisSessionConfig;
import com.core.config.Swagger2Config;

@Configuration
@ImportAutoConfiguration({Swagger2Config.class,HystrixConfig.class,RedisSessionConfig.class,JpaConfig.class,RabbitConfig.class})
